...
# 50000 ~ 100000 가격의 차량의 렌트횟수를 조회하기
SELECT
		COUNT(*) AS RENT_CNT
FROM
		RENT R
...
# 브랜드별로 렌트 횟수를 조회하고 렌트수가 많은 순서대로 정렬하기
SELECT

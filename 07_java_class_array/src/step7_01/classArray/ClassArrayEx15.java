...
public class ClassArrayEx15 {
	...
	public static void main(String[] args) {
		...
		HashMap<String, Integer> hMap = new HashMap<String, Integer>();
		//HashMap<String, Integer> hMap2 = new HashMap<>(); // 뒤쪽 제네릭은 데이터형을 생략할 수 있다.
		...
		hMap.put("data1", 10000); // 데이터의 수정
		hMap.put("data4", 4000);  // 데이터의 추가
		hMap.put("data5", 5000);  // 데이터의 추가
		System.out.println(hMap);
		...
		testMap.put("키1", "문자열 데이터");		
		testMap.put("키2", 100);
		testMap.put("키3", new TempMember());
		testMap.put("키3", new Product());		

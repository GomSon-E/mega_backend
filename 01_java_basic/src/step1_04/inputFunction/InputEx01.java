...
public class InputEx01 {
	...
	public static void main(String[] args) {
		...
		// 코드의 시작 부분에서 한번만 작성한다.
		Scanner scan = new Scanner(System.in);
		
		System.out.print("상품 가격을 입력하세요 : ");
		int getProductPrice = scan.nextInt(); // nextInt() : 메서드를 통하여 숫자를 입력받는다.
 		
		System.out.println("입력하신 상품 가격은 " + getProductPrice + "원 입니다.");
		System.out.println("부가세는 " + getProductPrice * 0.1 + "원 입니다.");
		System.out.println("총 결제 금액은 " + (getProductPrice + getProductPrice * 0.1) + "원 입니다.");
		
		System.out.print("월급을 입력하세요");
		int getSalary = scan.nextInt();
		
		System.out.println("입력하신 월급은 " + getSalary + "원 입니다.");
		System.out.println("원청징수 금액은 " + getSalary * 0.033 + "원 입니다.");
		System.out.println("실수령액은 " + (getSalary - getSalary * 0.033) + "원 입니다.");
		
		
		// 코드의 제일 마지막 부분에서 한번만 작성한다.
		scan.close();

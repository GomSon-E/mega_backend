...
public class ControllerToView {
	...
	public ModelAndView modelAndViewEx() { // return 타입은 String이 아닌 ModelAndView 클래스를 작성한다.
		...
		mv.addObject("method", "ModelAndView");		// 전송할 데이터를 작성한다.
	 ...
	 *
	 */
	@RequestMapping(value="/reponseEntityEx" , method=RequestMethod.GET)
	public ResponseEntity<Object> reponseEntityEx() {

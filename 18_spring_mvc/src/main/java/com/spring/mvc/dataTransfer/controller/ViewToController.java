...
public class ViewToController {
	...
	public String transfer1(HttpServletRequest request) {		
		...
		System.out.println("isPC : "    	 + request.getParameter("isPC"));
		System.out.println("locationCd : "   + request.getParameter("locationCd"));
	...
	// DTO 에 선언되지 않은 hidden 요소들은 넘어오지 않는다.
...
// 방법 2
	public String transfer2(MemberDto memberDto) { // @ModalAttribute 를 생략해도 된다.
	...
	// DTO 에 선언되지 않은 hidden 요소들도 받을 수 있다.
	/* 
	...
	public String transfer3(@RequestParam Map<String, Object> memberMap) { // input 태그의 name이 key, 입력값이 value로 들어온다
...
//  방법 1
	public String transfer4(/* @ModelAttribute MemberDto memberDto, */ // 같이 쓸 수도 있다.
							@RequestParam("isPC") boolean isPC , 
							@RequestParam("locationCd") int locationCd , 
							@RequestParam("lang") String lang) { 
							// 모든 변수를 String으로 받는 request.getParameter와 달리 데이터 형을 정해서 받을 수 있다.

//  방법 2
//	public String transfer4(boolean isPC , int locationCd , int lang) {  

//  방법 3
//	public String transfer4(@RequestParam(name="isPC", defaultValue="false") boolean isPC , 
//							@RequestParam(name="locationCd", defaultValue="-1") int locationCd , 
//							@RequestParam(name="lang", defaultValue="kor") int lang) { 
		
		System.out.println("\ntransfer4 \n");
		
		System.out.println("isPC : "    	 + isPC);
		System.out.println("locationCd : "   + locationCd);

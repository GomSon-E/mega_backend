...
<body>
	<form action="${contextPath}/member/register" method="post" onsubmit="return checkValidationField()" enctype="multipart/form-data">
		<h3>회원가입</h3>
		<table border="1">
			<tr>
				<td>아이디</td>
	        ...
	        <tr>
		        <td>이름</td>
		        <td><input type="text" name="memberNm" maxlength="15" placeholder="이름을 입력하세요." /></td>
	        </tr>                
		    <tr>
		        <td>성별</td>
		        <td>

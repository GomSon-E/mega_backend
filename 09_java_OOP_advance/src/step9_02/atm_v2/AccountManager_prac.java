...
public class AccountManager_prac {

	private AccountManager_prac() {}
	private static AccountManager_prac instance = new AccountManager_prac();
	public static AccountManager_prac getInstance() {
		return instance;
	}
	...
	void createAcc(int identifier) {
		...
		um.userList[identifier].acc[accCntByUser] = new Account_prac();
	...
	void printAcc(int identifier) {
		...
		User_prac temp = um.userList[identifier];
		System.out.println("====================");

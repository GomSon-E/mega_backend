...
<body>
	...
	<%-- 
	 ...
	 <c:set var="strData1" value="${fn:contains(fileName , '.png') }" />
	 <p>contain : ${strData1 } </p>
	 
	 <c:set var="strData2" value="${fn:substring(fileName , 10 , 13) }"/>
	 <p>substring : ${strData2 }</p>
	 
	 <c:set var="strData3" value="${fn:replace(fileName , '.png' , '.jpg') }"/>
	 <p>fn:replace : ${strData3 }</p>

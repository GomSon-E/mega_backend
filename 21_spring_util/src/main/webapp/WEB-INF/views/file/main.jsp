...
<body>
	...
	<table border="1">			
		...
		<tr>
			<td><img src="${contextPath }/file/thumbnails?fileName=404.PNG" width="300"></td>
			<td>404 이미지</td>
			<td><a href="${contextPath }/file/download?fileName=404.PNG">다운로드</a></td>
		</tr>
		<tr>
			<td><img src="${contextPath }/file/thumbnails?fileName=500.PNG" width="300"></td>
			<td>500 이미지</td>
	...
	<form action="${contextPath }/file/delete" method="get" >
		<h1>파일 삭제</h1>
		<table>			
			<tr>
				<td>삭제할 파일명 : </td>
